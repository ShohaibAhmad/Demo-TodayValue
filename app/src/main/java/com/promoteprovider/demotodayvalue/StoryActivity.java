...
public class StoryActivity extends AppCompatActivity {
    ...
    private void uploadStory() {
        ...
        SimpleDateFormat currentDate1 = new SimpleDateFormat("HH:mm:ss");
        final String saveLine = currentDate1.format(calendar1.getTime());

        String time = saveDate + ":" + saveLine;
        ...
        if (TextUtils.isEmpty(caption) || uri != null){
            ...
            Toast.makeText(this, "Are Required", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        documentReference.get()
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                   ...
                   if (task.getResult().exists()){
                       name = task.getResult().getString("FirstName");
